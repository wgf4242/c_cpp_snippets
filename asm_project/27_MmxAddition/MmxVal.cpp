...
char* MmxVal::ToString_u8(char* s, size_t len) {
	sprintf_s(s, len, "%4d %4d %4d %4d %4d %4d %4d %4d", u8[0], u8[1], u8[2], u8[3], u8[4], u8[5], u8[6], u8[7]);
	return s;
}
...
char* MmxVal::ToString_x8(char* s, size_t len) {
	sprintf_s(s, len, "%4x %4x %4x %4x %4x %4x %4x %4x", u8[0], u8[1], u8[2], u8[3], u8[4], u8[5], u8[6], u8[7]);
	return s;
}

char* MmxVal::ToString_x16(char* s, size_t len) {
	sprintf_s(s, len, "%8x %8x %8x %8x", u16[0], u16[1], u16[2], u16[3]);
	return s;
}


char* MmxVal::ToString_x32(char* s, size_t len) {
	sprintf_s(s, len, "%12x %12x", u32[0], u32[1]);
	return s;
}


char* MmxVal::ToString_x64(char* s, size_t len) {
	sprintf_s(s, len, "%16llx", u64);
	return s;
}
