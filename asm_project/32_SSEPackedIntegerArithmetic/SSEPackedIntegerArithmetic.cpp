...
extern "C" void SsePackedInt16_Add(const XmmVal * a, const XmmVal * b, const XmmVal c[2]);
extern "C" void SsePackedInt32_Sub(const XmmVal * a, const XmmVal * b, const XmmVal * c);
extern "C" void SsePackedInt32_Mul(const XmmVal * a, const XmmVal * b, const XmmVal c[2]);
...
void SsePackedInt32_Sub_Test(void) {
	_declspec(align(16)) XmmVal a;
	_declspec(align(16)) XmmVal b;
	_declspec(align(8))  XmmVal c; // 如果用dqa 这里和16对齐
	char buff[256];
