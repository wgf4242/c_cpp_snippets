...
function(x64dbg_plugin target)
    ...
    # Release optimizations to reduce size
    if(CMAKE_BUILD_TYPE STREQUAL "Release")
        target_compile_options(${target} PRIVATE "$<$<CXX_COMPILER_ID:MSVC>:/O2>")
        target_compile_options(${target} PRIVATE "$<$<CXX_COMPILER_ID:MSVC>:/Ob2>")
        target_compile_options(${target} PRIVATE "$<$<CXX_COMPILER_ID:MSVC>:/Oi>")
        target_compile_options(${target} PRIVATE "$<$<CXX_COMPILER_ID:MSVC>:/Ot>")
        target_compile_options(${target} PRIVATE "$<$<CXX_COMPILER_ID:MSVC>:/Oy>")
        target_compile_options(${target} PRIVATE "$<$<CXX_COMPILER_ID:MSVC>:/GL>")
        target_compile_options(${target} PRIVATE "$<$<CXX_COMPILER_ID:MSVC>:/Gy>")
        target_link_options(${target} PRIVATE "$<$<CXX_COMPILER_ID:MSVC>:/LTCG>")
        target_link_options(${target} PRIVATE "$<$<CXX_COMPILER_ID:MSVC>:/OPT:REF>")
        target_link_options(${target} PRIVATE "$<$<CXX_COMPILER_ID:MSVC>:/OPT:ICF>")
    endif()
